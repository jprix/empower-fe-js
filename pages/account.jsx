...
export default function Account() {
  ...
  const handleCredentialChange = (event) => {
    const account = user?.verifiedCredentials.find(
      (vc) => vc.id === event.target.value
    );
          ...
          {user ? (
            <>
              <List>
                ...
                <ListItem>
                  <Typography variant="body1">
                    <strong>Environment ID:</strong> {user.environmentId}
                  </Typography>
                </ListItem>
                <ListItem>
                  <Typography variant="body1">
                    <strong>New User:</strong> {user.newUser ? "Yes" : "No"}
                  </Typography>
                </ListItem>
                <ListItem>
                  <Typography variant="body1">
                    <strong>Last Verified Credential ID:</strong>{" "}
