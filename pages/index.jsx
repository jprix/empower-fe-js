      ...
      <main className="bg-blue-50">
        <section className="bg-primary text-white py-20">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg mt-4">
              Get your verified Proof of Funds in minutes. No more screenshots or waiting on your bank—instant, secure, and ready when you need it.            </p>
            <button
        ...
        <section className="container mx-auto px-4 py-16 text-center ">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-primary">Knowledgeable Experts</h3>
            ...
            <div>
              <h3 className="text-2xl font-bold text-primary">Rapid Response</h3>
              <p className="mt-4 text-gray-600">
              We understand that time is of the essence. That's why we prioritize quick and efficient responses to all your inquiries.
              </p>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-primary">No Cost to You</h3>
              <p className="mt-4 text-gray-600">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-xl font-bold text-primary">Personal Loans</h3>
                <p className="mt-4">
                  Apply online, get instant offers, and receive your funds.  Simple!
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-xl font-bold text-primary">Loan Consolidation</h3>
                <p className="mt-4">
