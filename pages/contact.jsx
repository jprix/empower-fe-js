        ...
        <div className="o3-contact-grid">
          ...
          <section className="o3-contact-form-shell">
            <div className="o3-contact-success">
              ...
              <h2>Ready to Talk?</h2>
              <p>
                There is no form on this page. If you want help right away, call
                our team directly or start your application on the dedicated
                apply page.
              </p>
              <a href="tel:8664901617">(866) 490-1617</a>
              <span>Available Monday through Friday, 8am to 8pm ET.</span>
              <a href="/apply-now" className="o3-form-submit">
